...
const firstNames = ['James', 'John', 'Robert', 'William', 'David', 'Richard', 'Thomas', 'Paul', 'Mark'];
const lastNames = ['Smith', 'Johnson', 'Williams', 'Jones', 'Brown', 'Davis', 'Johnson', 'Miller', 'Wilson', 'Moore', 'Taylor', 'Anderson']
const companyTitles = ["Pharmacy tech","Pharmacist"]
const groupNames = ["Lucky-Staff","SP-Staff","Radnor-Staff"]
const companyNames = ['Lucky Pharmacy','South Philadelphia Pharmacy','Radnor Pharmacy']
const emails = ["miker@gmail.com","reggiemiller@yahoo.com","jjreddick@hotmail.com","miker@gmail.com","reggiemiller@yahoo.com","jjreddick@hotmail.com","ojmayo@gmail.com"]
